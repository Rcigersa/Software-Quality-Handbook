...
The estimation technique you choose is determined by the final results you expect to see. The end objective of story estimation is the same regardless of which method you select. Various techniques, on the other hand, provide different opportunities for you and your team to engage in a variety of talks, so change your estimation strategy depending on the type of conversation you want to have. What matters most is that you help your team understand the problems and limitations. If estimating takes too long, you are probably not using a strategy correctly. 
